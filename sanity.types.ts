...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | Product | Sales | Category | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | Slug;
export declare const internalGroqTypeReferenceTo: unique symbol;
// Source: ./sanity/helpers/query.ts
// Variable: SALES_QUERY
// Query: *[_type == 'sales'] | order(name asc)
...
// Query: *[  _type == 'product' &&   lower(name) match lower($searchParam + '*')] | order(name asc)
...
// Query: *[  _type == "product" &&   references(*[_type == "category" && lower(slug.current) == lower($categorySlug)]._id)] | order(name asc)
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == 'sales'] | order(name asc)": SALES_QUERYResult;
